...
export type GetTelegramChatMemberAggregateType<T extends TelegramChatMemberAggregateArgs> = {
      [P in keyof T & keyof AggregateTelegramChatMember]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
...
export type GetTelegramChatMemberGroupByPayload<T extends TelegramChatMemberGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TelegramChatMemberGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TelegramChatMemberGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
...
export type TelegramChatMemberCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TelegramChatMemberFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TelegramChatMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TelegramChatMember'], meta: { name: 'TelegramChatMember' } }
  /**
  ...
  count<T extends TelegramChatMemberCountArgs>(
    ...
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TelegramChatMemberCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, TelegramChatMemberGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTelegramChatMemberGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
