...
export type GetCommentKeywordMatchAggregateType<T extends CommentKeywordMatchAggregateArgs> = {
      [P in keyof T & keyof AggregateCommentKeywordMatch]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
...
type GetCommentKeywordMatchGroupByPayload<T extends CommentKeywordMatchGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CommentKeywordMatchGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CommentKeywordMatchGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
...
export type CommentKeywordMatchCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CommentKeywordMatchFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CommentKeywordMatchDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CommentKeywordMatch'], meta: { name: 'CommentKeywordMatch' } }
  /**
  ...
  count<T extends CommentKeywordMatchCountArgs>(
    ...
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CommentKeywordMatchCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, CommentKeywordMatchGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCommentKeywordMatchGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
