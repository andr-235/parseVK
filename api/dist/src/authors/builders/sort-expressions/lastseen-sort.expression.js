...
export class LastSeenSortExpression {
    build(order) {
      ...
      END
    `;
        const timeFromObject = SortUtils.buildUnixMillisExpression(Prisma.sql `"Author"."lastSeen"->>'time'`);
...
//# sourceMappingURL=lastseen-sort.expression.js.map