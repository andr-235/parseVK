    ...
    try {
        ...
        app.useGlobalPipes(new ValidationPipe({
            ...
            exceptionFactory: (errors) => {
                ...
                validationLogger.error(`Validation failed: ${messages.join('; ')}`, JSON.stringify(errors, null, 2));
        ...
        const portRaw = configService.get('port', { infer: true });
        ...
        const logger = new Logger('Bootstrap');
        logger.error('Не удалось запустить приложение', err instanceof Error ? err.stack : undefined);
        process.exit(1);
    }
}
void bootstrap();
