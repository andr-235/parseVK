...
import type { TelegramChatType, TelegramMemberStatus } from '../types/telegram.enums.js';
export interface ITelegramClient {
    getClient(): Promise<TelegramClient>;
    disconnect(): Promise<void>;
}
export type TelegramIdentifierKind = 'username' | 'publicLink' | 'inviteLink' | 'numericId' | 'channelNumericId' | 'invalid';
