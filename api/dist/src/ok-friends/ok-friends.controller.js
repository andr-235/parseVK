...
let OkFriendsController = OkFriendsController_1 = class OkFriendsController {
    okFriendsService;
    exportJobService;
    fileService;
    jobStream;
    logger = new Logger(OkFriendsController_1.name);
    constructor(okFriendsService, exportJobService, fileService, jobStream) {
    ...
    streamJob(jobId) {
        return defer(() => from(this.okFriendsService.getJobById(jobId))).pipe(mergeMap((job) => {
            if (!job) {
                throw new NotFoundException('Export job not found');
            }
            if (job.status === 'DONE') {
...
__decorate([
    ...
    __metadata("design:paramtypes", [OkFriendsExportRequestDto]),
    __metadata("design:returntype", Promise)
], OkFriendsController.prototype, "export", null);
__decorate([
    Get('jobs/:jobId'),
    ...
    __metadata("design:returntype", Promise)
], OkFriendsController.prototype, "getJob", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], OkFriendsController.prototype, "downloadXlsx", null);
__decorate([
...
], OkFriendsController.prototype, "streamJob", null);
OkFriendsController = OkFriendsController_1 = __decorate([
...
export { OkFriendsController };
//# sourceMappingURL=ok-friends.controller.js.map