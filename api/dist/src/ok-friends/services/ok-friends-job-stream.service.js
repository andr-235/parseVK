...
let OkFriendsJobStreamService = class OkFriendsJobStreamService {
    streams = new Map();
    getStream(jobId) {
...
OkFriendsJobStreamService = __decorate([
    Injectable()
], OkFriendsJobStreamService);
export { OkFriendsJobStreamService };
//# sourceMappingURL=ok-friends-job-stream.service.js.map