...
let OkFriendsRepository = class OkFriendsRepository {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async getJobById(jobId) {
        ...
        return {
            ...job,
            okUserId: job.okUserId
                ? job.okUserId.toString()
                : null,
        };
    }
...
OkFriendsRepository = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [PrismaService])
], OkFriendsRepository);
export { OkFriendsRepository };
//# sourceMappingURL=ok-friends.repository.js.map