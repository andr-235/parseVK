...
let VkFriendsJobStreamService = class VkFriendsJobStreamService {
    streams = new Map();
    getStream(jobId) {
...
VkFriendsJobStreamService = __decorate([
    Injectable()
], VkFriendsJobStreamService);
export { VkFriendsJobStreamService };
//# sourceMappingURL=vk-friends-job-stream.service.js.map