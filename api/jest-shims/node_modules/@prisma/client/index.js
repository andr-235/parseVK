...
const MatchSource = createEnum(['COMMENT', 'POST']);
const TelegramChatType = createEnum(['PRIVATE', 'GROUP', 'SUPERGROUP', 'CHANNEL']);
const TelegramMemberStatus = createEnum(['CREATOR', 'ADMINISTRATOR', 'MEMBER', 'RESTRICTED', 'LEFT', 'KICKED']);
