...
class ContentRepo(Protocol):
    ...
    async def list_authors(self, offset: int = 0, limit: int = 20, search: str | None = None, city: str | None = None, verified: bool | None = None, sort_by: str | None = None, sort_order: str = "desc") -> dict: ...
...
class ContentService:
    def __init__(self, *, repo: ContentRepo, photo_analysis: PhotoAnalysisClient | None = None):
        self._repo = repo
