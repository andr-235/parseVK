...
from app.infrastructure.db.models import ContentGroup
...
def group_to_dict(row: ContentGroup) -> dict:
    return {
        ...
        "createdAt": serialize_datetime(row.updated_at),
        "lastCollectedAt": serialize_datetime(row.last_collected_at),
