...
class TelegramServiceClientError(Exception):
    pass


class TelegramServiceClientHTTPError(TelegramServiceClientError):
    def __init__(self, status_code: int, detail: Any) -> None:
        self.status_code = status_code
        self.detail = detail
        super().__init__(f"Telegram service returned HTTP {status_code}")


class TelegramServiceClientUnavailableError(TelegramServiceClientError):
    pass
...
class TelegramServiceClient:
    def __init__(
        ...
        self._internal = InternalServiceClient(
            ...
            base_url=base_url or settings.telegram_service_base_url,
    ...
    async def request(
        ...
        *,
        ...
        try:
            ...
            raise TelegramServiceClientHTTPError(
                status_code=exc.status_code, detail=exc.detail
            ) from exc
        except InternalClientUnavailableError as exc:
            raise TelegramServiceClientUnavailableError("Telegram service is unavailable") from exc
