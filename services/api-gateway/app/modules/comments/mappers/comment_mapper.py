...
def format_comment_detail(
    ...
    return {
        ...
        "author": {
            ...
            "screen_name": author_profile.get("screenName") if author_profile else None,
            "photo_50": author_profile.get("photo50") if author_profile else None,
        },
        "group": {
            "name": group_profile.get("name"),
            "screen_name": group_profile.get("screenName"),
            "vk_group_id": group_profile.get("vkGroupId"),
            "photo_50": group_profile.get("photo50") if group_profile else None,
