...
class KeywordsGatewayService:
    def __init__(self, moderation_client: ModerationClient | None = None):
        ...
        def _request(m, p, **kw):
            return svc._request(m, p, **kw)

        def _fmt_kw(kw):
            return svc._format_keyword(kw)
    ...
    async def get_all_keywords(
        ...
        *,
        ...
        return await self._crud.get_all_keywords(
            page, limit, search, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )
    ...
    async def add_keyword(
        ...
        *,
        ...
        return await self._crud.add_keyword(
            payload, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )
    ...
    async def bulk_add_keywords(
        ...
        *,
        ...
        return await self._crud.bulk_add_keywords(
            payload, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )
    ...
    async def upload_keywords(
        ...
        *,
        ...
        return await self._crud.upload_keywords(
            file, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )
    ...
    async def update_keyword_category(
        ...
        *,
        ...
        return await self._crud.update_keyword_category(
            id, payload, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )

    async def delete_all_keywords(
        self, *, user_id: str | None = None, request_id: str | None = None, correlation_id: str | None = None
    ) -> dict:
        return await self._crud.delete_all_keywords(
            user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )

    async def delete_keyword(
        self, id: int, *, user_id: str | None = None, request_id: str | None = None, correlation_id: str | None = None
    ) -> dict:
        return await self._crud.delete_keyword(
            id, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )

    async def get_keyword_forms(
        self, id: int, *, user_id: str | None = None, request_id: str | None = None, correlation_id: str | None = None
    ) -> dict:
        return await self._forms.get_keyword_forms(
            id, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )
    ...
    async def add_manual_keyword_form(
        ...
        *,
        ...
        return await self._forms.add_manual_keyword_form(
            id, payload, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )
    ...
    async def remove_manual_keyword_form(
        ...
        *,
        ...
        return await self._forms.remove_manual_keyword_form(
            id, payload, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )
    ...
    async def add_keyword_form_exclusion(
        ...
        *,
        ...
        return await self._forms.add_keyword_form_exclusion(
            id, payload, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )
    ...
    async def remove_keyword_form_exclusion(
        ...
        *,
        ...
        return await self._forms.remove_keyword_form_exclusion(
            id, payload, user_id=user_id, request_id=request_id, correlation_id=correlation_id
        )
