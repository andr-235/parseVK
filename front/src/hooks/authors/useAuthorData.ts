...
import { authorsService } from '@/api/authors/authors.api'
import { useAuthorsStore } from '@/store/authors'
import { createEmptyPhotoAnalysisSummary, type AuthorDetails } from '@/types'
import type { AuthorAnalysisLocationState } from '@/types/authorAnalysis/authorAnalysis'
import { isValidAuthorId } from '@/utils/authors/authorUtils'
