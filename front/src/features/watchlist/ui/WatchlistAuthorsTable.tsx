...
import { filterValidAuthors, validateAuthorId } from '@/features/watchlist/lib/watchlistUtils'
import { logger } from '@/features/watchlist/lib/logger'
  ...
  ({
    ...
    return (
      ...
      >
        ...
        {isLoading ? <LoadingState key="loading-state" /> : null}

        {/* Отображение пустого состояния когда данные загружены но список пуст */}
        {isEmpty ? <EmptyState key="empty-state" /> : null}
          ...
          <Table
            ...
            aria-activedescendant={
              focusedRowIndex !== null
                ...
                : undefined
            } // Текущий активный элемент при клавиатурной навигации
            key="authors-table"
          >
