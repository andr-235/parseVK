      ...
      <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center rounded-lg bg-muted/20 p-1 border border-border/40">
             <Button
                ...
                className={cn("h-7 rounded-md px-3 text-xs font-medium transition-all", readFilter === 'all' ? "bg-background shadow-sm text-foreground" : "text-muted-foreground hover:text-foreground")}
             >
                Все
             </Button>
             <Button
                ...
                className={cn("h-7 rounded-md px-3 text-xs font-medium transition-all", readFilter === 'unread' ? "bg-background shadow-sm text-foreground" : "text-muted-foreground hover:text-foreground")}
             >
                Непрочитанные
             </Button>
             <Button
                ...
                className={cn("h-7 rounded-md px-3 text-xs font-medium transition-all", readFilter === 'read' ? "bg-background shadow-sm text-foreground" : "text-muted-foreground hover:text-foreground")}
             >
                Прочитанные
             </Button>
          </div>
          ...
          {keywordsCount > 0 && (
            <>
             ...
             <Badge variant="secondary" className="h-6 px-2 text-[10px] bg-muted text-muted-foreground border-0 ml-auto sm:ml-0">
