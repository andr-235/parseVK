          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
              />
              <p className="text-xs text-text-secondary">Время сервера</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
              />
              <p className="text-xs text-text-secondary">Постов на группу</p>
            </div>
          </div>
        </form>
      </CardContent>
  ...
  return (
    <Card className="flex h-full flex-col border-border/50 bg-background-secondary/40 shadow-sm">
      ...
      <CardContent className="flex-1 space-y-6">
        <div className="flex items-start gap-3 rounded-md bg-accent-primary/10 p-4 text-sm text-accent-primary">
        ...
        <PageHeader
          ...
          actions={
            <Button
              ...
              size="lg"
              className={cn(
                'group relative h-11 shrink-0 overflow-hidden font-semibold text-text-light shadow-lg transition-all duration-300 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed',
                automationEnabled
                  ? 'bg-accent-primary shadow-soft-sm'
