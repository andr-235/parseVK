    ...
    <PageHeroCard
      ...
      actions={
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Badge variant="outline" className="border-accent-primary/40 text-accent-primary px-4 py-2 text-xs font-semibold">
            Непрочитанные: {unreadCount}
          </Badge>
          <Badge variant="outline" className="border-border text-text-secondary px-4 py-2 text-xs font-semibold">
