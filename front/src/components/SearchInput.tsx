...
const DEFAULT_CLEAR_BUTTON_CLASSES =
...
const SearchInput = memo(function SearchInput({
  ...
  const resolvedInputClassName = useMemo(
    ...
    [baseInputClass, paddingLeftClass, paddingRightClass, isGlass, inputClassNameProp]
  )
  ...
  const clearButtonClassName = useMemo(
    () =>
      cn(
        ...
        isGlass ? GLASS_CLEAR_BUTTON_CLASSES : DEFAULT_CLEAR_BUTTON_CLASSES
      ),
    [isGlass]
  )
