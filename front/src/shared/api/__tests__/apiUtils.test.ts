...
vi.mock('@/shared/auth/config/lib/authSession', async () => {
  const actual = await vi.importActual<typeof import('@/shared/auth/config/lib/authSession')>(
    '@/shared/auth/config/lib/authSession'
  )
  return {
    ...actual,
