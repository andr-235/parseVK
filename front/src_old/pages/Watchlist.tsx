...
import { useWatchlistViewModel } from '@/features/watchlist/model/useWatchlistViewModel'
import { WatchlistTableCard } from '@/features/watchlist/ui/WatchlistTableCard'
import { WatchlistAuthorDetails } from '@/features/watchlist/ui/WatchlistAuthorDetails'
      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
        <div className="space-y-1.5">
          ...
          <p className="max-w-2xl text-muted-foreground">
            Отслеживайте активность выбранных авторов в комментариях. Система проверяет новые
            комментарии от этих пользователей во всех отслеживаемых группах.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {settings && (
            <Button
              ...
              className="h-9"
              title={
                settings.trackAllComments ? 'Отслеживание включено' : 'Отслеживание приостановлено'
              }
            >
