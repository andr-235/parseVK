...
- Ввести базовую аутентификацию и авторизацию (API ключ или JWT + роли) и применить глобальный guard с исключениями для health/metrics при необходимости (оценка: средняя, зависимость: решение по модели доступа).
